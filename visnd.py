...
dropdown = st.sidebar.selectbox(
    ...
    ("Three Point Problem Solver", "Resultant Vector Calculator", "Calculation of Attitude of Bed from 2 Borehole Data","Calculation of separation of Litho-contact due to Faulting","Calculation of Apparent thickness of Bed","Calculation of True Dip from 2 Apparent dip and dip directions","Orientation of intersection line of 2 planes")
)
